...
PRETRAINED_MODEL_PATH = "toxicityModel25small_baseline.h5"
...
# model1.save("toxicityModel25small_to_peptide_freezeGNN_folded.h5")
...
# model2.save("toxicityModel25small_to_peptide_freezeReadout_folded.h5")
...
model3.save("toxicityModel25small_to_peptide_freezeAllNewOutput_folded.h5")
